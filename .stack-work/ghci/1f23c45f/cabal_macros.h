...
/* package refal-llvm-0.1.0.0 */
#ifndef VERSION_refal_llvm
#define VERSION_refal_llvm "0.1.0.0"
#endif /* VERSION_refal_llvm */
#ifndef MIN_VERSION_refal_llvm
#define MIN_VERSION_refal_llvm(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_refal_llvm */
...
#define CURRENT_COMPONENT_ID "refal-llvm-0.1.0.0-4IISHWsaqPG8ixUMi85yZh-refal-llvm"
